...
export function activate(context: vscode.ExtensionContext) {
        ...
        console.log('Extension "copy-with-timestamp" is now active');

        // Register the command to create a copy of a file with timestamp
        let disposable = vscode.commands.registerCommand('copyWithTimestamp', async (fileUri?: vscode.Uri) => {
                ...
                try {
                        ...
                        vscode.window.showInformationMessage(`Created timestamped copy: ${newName}`);
                } catch (error) {
